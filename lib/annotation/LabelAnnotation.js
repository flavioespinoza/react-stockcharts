  ...
  _createClass(LabelAnnotation, [{
    ...
    value: function render() {
      var _props2 = this.props,
        ...
        classNameUniq = _props2.classNameUniq,
      ...
      var _helper = helper(this.props, xAccessor, xScale, yScale),
        ...
        __classNameUniq = _helper.classNameUniq

      // console.log('_helper', _helper);

      return React.createElement(
        "g", { className: className + ' ' + __classNameUniq },
        React.createElement(
          "title",
          null,
          tooltip
...
export function helper(props, xAccessor, xScale, yScale) {
  var x = props.x,
    ...
    classNameUniq = props.classNameUniq;
  ...
  return {
    ...
    classNameUniq: functor(classNameUniq)(datum)
  };
}
